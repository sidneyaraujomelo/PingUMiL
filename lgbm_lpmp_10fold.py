...
experiment_df.to_csv("lgb_sg3f_10fold_trainval.csv")
print(experiment_df.describe())

output_df = pd.DataFrame.from_dict(output_dict)
output_df.to_csv("lgb_sg3f_10fold_test.csv")
...
experiment_df = pd.DataFrame.from_dict(experiment_control_dict)
experiment_df.to_csv("lgb_sg3f_csf_10fold_trainval.csv")
print(experiment_df.describe())

output_df = pd.DataFrame.from_dict(output_dict)
output_df.to_csv("lgb_sg3f_csf_10fold_test.csv")
print(output_df.describe())