...
def main():
    basepaths = ["../smokesquadrondataset/original provenance graphs", "../smokesquadrondataset/replay experiment"]
    match_dict = {}
    for basepath in basepaths:
        for root, dirs, files in os.walk(basepath):
            for input_file in files:
                players_df = process_prov_xml(os.path.join(root, input_file))
                match_dict[os.path.basename(input_file)] = players_df
