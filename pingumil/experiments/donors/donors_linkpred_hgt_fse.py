...
typeproj_optimizer = torch.optim.Adam(typeproj_model.parameters(), lr=1e-5, weight_decay=1e-6)
gnn_optimizer = torch.optim.Adam(gnn_model.parameters(), lr=1e-5, weight_decay=1e-6)
...
link_optimizer = torch.optim.Adam(linkpred_model.parameters(), lr=1e-5, weight_decay=1e-6)
