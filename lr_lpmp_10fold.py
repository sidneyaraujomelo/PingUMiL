...
def run(add_cluster=False, num_clusters=5, base_clustering="kmeans", output_base_filename = "lr_sk10f"):
...
if __name__ == "__main__":
    run()
    run(add_cluster=True, num_clusters=5, base_clustering="kmeans", output_base_filename = "lr_sk10f")
    for i in [5, 10, 20]:
        run(add_cluster=True, num_clusters=i, base_clustering="spectralg55", output_base_filename = "lr_sk10f")