...
experiment = SSHetBaseExperiment(experiment_tag="thirdprop", epochs=1000, timestamp=time.time())
print(experiment.output_file)
#Read all necessary data
data, atbsets_list, node_maps, node_feats, train_folds, test_folds = experiment.read_data()

#wandb stuff
wandb.init(project="fsp", group="sshet_mhafse_f")
