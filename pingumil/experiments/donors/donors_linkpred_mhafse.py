...
wandb.init(project="fsp", group="donors_mhafse",
                 config={
                    "batch_size" : 1024
                 })
experiment = DonorsBaseExperiment(experiment_tag="linkpred_mhafse", epochs=100, patience=20,
...
mha_early_stopping = experiment.get_early_stopping(patience=experiment.patience, verbose=True, prefix=f"mha")
best_loss = 50000
